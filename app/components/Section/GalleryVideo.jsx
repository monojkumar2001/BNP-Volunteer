...
const GalleryVideo = () => {
  ...
  return (
    <>
      <section
        className="who-section gallery-video"
        data-aos="fade-up"
          ...
          <div className="row align-items-center">
            <div className="col-lg-6">
              <div className="who-content">
                <div className="subtitle">The best Capture moments</div>
            ...
            <div className="col-lg-6">
              <div className="who-image-wrapper who-video-wrapper">
                <Image
                  src="/assets/images/gallery-video.png"
                  alt="Who we are"
                  width={633}
                  height={507}
                />
