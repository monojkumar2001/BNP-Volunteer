          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-6">
              <div className="who-content">
                ...
                <p>
                  {language === "bn"
                    ? "বাংলাদেশের মানুষ সম্মানের সাথে মাথা উঁচু করে বাঁচতে চায়। কিন্তু জনস্বার্থে সকলে মিলে দীর্ঘমেয়াদী পরিকল্পনা বাস্তবায়নে আমরা কতটা সক্ষম? অক্সফোর্ডে পড়াকালিন সময় দেখেছি বিভিন্ন গোষ্ঠীর মাঝে যতই বিরোধ থাকুক, স্থানীয় সমস্যা সমাধানে সবাই মিলে কাজ করে। ক্ষুদ্র ব্যক্তিস্বার্থের তুলনায় সামষ্টিক সমৃদ্ধি বেশি প্রাধান্য পায়। নিজেদের ভবিষ্যতের স্বার্থে আমরা কেন পারবো না একযোগে কাজ করতে?"
