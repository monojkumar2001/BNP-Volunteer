...
const AboutSection = () => {
  ...
  return (
    <>
      <section
        className={`leadership-2 about-item-section ${
      ...
      >
        <div className="container">
              ...
              <div className="who-content">
                ...
                {/* <ul>
                     <li>
                       {language === "bn" ? (
                         <>
                           মুহাম্মদ নওশাদ জমির একজন অভিজ্ঞ আইনজীবী। তিনি লন্ডনের
          ...
          <div>
              ...
              {language === "bn" ? (
                <>
                  <p>
                    ...
                    <strong>আন্তর্জাতিক বিষয়ক সম্পাদক</strong> মুহাম্মদ নওশাদ
                  ...
                  <p>
                    ২০০১ সাল থেকে মুহাম্মদ নওশাদ জমির রাজনীতির সাথে সরাসরি
                    সম্পৃক্ত হন।{" "}
            ...
            <div className="leadership-item-head" style={{ paddingTop: "0" }}>
              <ul className="why-choose-list leadership-list-item">
                <li>
                  <div className="why-choose-icon">
                    <Image
