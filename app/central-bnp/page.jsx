...
import AllCentralBnpItem from "../components/CentralBnp/AllCentralBnpItem";
...
const AllCentralBnpPage = () => {
  const bannerData = {
    title_en: "Central BNP",
    title_bn: "কেন্দ্রীয় বিএনপি",
...
export default AllCentralBnpPage;
